...
class FullNode:
    ...
    async def _start(self):
        ...
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('hints','hint_index','1104662 3')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('hints','sqlite_autoindex_hints_1','1104662 1 1')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('coin_record','coin_spent_index','182920291 312')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('coin_record','coin_confirmed_index','182920291 265')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('coin_record','coin_parent_index','182920291 12')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('coin_record','coin_puzzle_hash','182920291 23')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('coin_record','sqlite_autoindex_coin_record_1','182920291 1')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('sub_epoch_segments_v3','sqlite_autoindex_sub_epoch_segments_v3_1','5050 1')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('full_blocks','main_chain','1939734 1 1')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('full_blocks','is_fully_compactified','1939734 969867 969867')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('full_blocks','height','1940736 2')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('full_blocks','sqlite_autoindex_full_blocks_1','1940736 1')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('current_peak','sqlite_autoindex_current_peak_1','1 1')")
        await db_connection.execute("INSERT INTO sqlite_stat1 VALUES('database_version',NULL,'1')")
