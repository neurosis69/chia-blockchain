...
class FullNode:
    ...
    async def _start(self):
        ...
        await (await db_connection.execute("pragma page_size=16384")).close()
        ...
        await db_connection.execute("INSERT INTO table VALUES('coin_record','coin_spent_index','182920291 312')")
        await db_connection.execute("INSERT INTO table VALUES('coin_record','coin_confirmed_index','182920291 265')")
        await db_connection.execute("INSERT INTO table VALUES('coin_record','coin_parent_index','182920291 12')")
        await db_connection.execute("INSERT INTO table VALUES('coin_record','coin_puzzle_hash','182920291 23')")
        await db_connection.execute("INSERT INTO table VALUES('coin_record','sqlite_autoindex_coin_record_1','182920291 1')")
        await db_connection.execute("INSERT INTO table VALUES('sub_epoch_segments_v3','sqlite_autoindex_sub_epoch_segments_v3_1','5050 1')")
        await db_connection.execute("INSERT INTO table VALUES('full_blocks','main_chain','1939734 1 1')")
        await db_connection.execute("INSERT INTO table VALUES('full_blocks','is_fully_compactified','1939734 969867 969867')")
        await db_connection.execute("INSERT INTO table VALUES('full_blocks','height','1940736 2')")
        await db_connection.execute("INSERT INTO table VALUES('full_blocks','sqlite_autoindex_full_blocks_1','1940736 1')")
