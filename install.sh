...
install_sqlite3() {
  ...
  echo 'CFLAGS="-DSQLITE_ENABLE_BATCH_ATOMIC_WRITE=1 -DSQLITE_ENABLE_ATOMIC_WRITE=1 -DSQLITE_DIRECT_OVERFLOW_READ=1"'
  # '| stdbuf ...' seems weird but this makes command outputs stay in single line.
  export CFLAGS="-DSQLITE_ENABLE_BATCH_ATOMIC_WRITE=1 -DSQLITE_ENABLE_ATOMIC_WRITE=1 -DSQLITE_DIRECT_OVERFLOW_READ=1"
